...
// Inicialización del estado para el store 'todoList'
wp_interactivity_state( 'todoList', array(
    'tasks' => array(
...
<div data-wp-interactive="todoList" class="wp-block-demo-todo-block todo-app">
