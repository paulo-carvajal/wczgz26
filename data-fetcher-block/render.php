...
// Inicialización del estado para el store 'dataFetcher'
wp_interactivity_state( 'dataFetcher', array(
    'posts' => array(),
    'isLoading' => false,
    'error' => null,
    'currentPage' => 1,
...
<div data-wp-interactive="dataFetcher" data-wp-init="callbacks.loadInitialData" class="wp-block-demo-data-fetcher-block">
    <!-- Lista de posts -->
